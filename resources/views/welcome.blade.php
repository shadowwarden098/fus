  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @keyframes float {
      ...
      50% { transform: translateY(-200px) translateX(100px); opacity: 0.4; }
...
<body>
  ...
  <!-- Botones de acción -->
  <a href="{{ route('usuarios.create') }}">Registrar Jugador</a>
  <a href="{{ route('admin.login') }}">Iniciar Sesión Administrador</a>
